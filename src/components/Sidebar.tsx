...
const menuItems = [
    ...
    { path: '/files-upload', label: 'Tải file', icon: MdOutlineUploadFile, color:'text-black' },
    { path: '/criteriaComparisonMatrix', label: 'Nhập thủ công', icon: FiEdit, color:'text-black' },
